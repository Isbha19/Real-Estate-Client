...
import { loadunverifiedcompany, verifyCompany } from '../../../../shared/store/company/unVerifiedCompany/unVerifiedCompany.action';
...
verifyCompany(companyId:number){
  this.storeNgrx.dispatch(verifyCompany({ companyId: companyId }));
}
